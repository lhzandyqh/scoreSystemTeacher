...
<script>
import termGradeAverageTable from '@/views/renkeTeacherGradeReport/nianjiAnalysis/allPreviousGrade/tableAndChart/termGradeAverageTable'
import termTrendChart from '@/views/renkeTeacherGradeReport/nianjiAnalysis/allPreviousGrade/tableAndChart/termTrendChart'
import inTermSixRatesTable from '@/views/renkeTeacherGradeReport/nianjiAnalysis/allPreviousGrade/tableAndChart/inTermSixRatesTable'
import inTermSixRatesChart from '@/views/renkeTeacherGradeReport/nianjiAnalysis/allPreviousGrade/tableAndChart/inTermSixRatesChart'
import { getGradeSuccessiveAverageScoreData, getGradeSuccessiveSixRatesData } from '@/api/gradeProfilesData'
export default {
  name: 'AllPrevious',
  ...
  methods: {
    getAverageData: function() {
      ...
      getGradeSuccessiveAverageScoreData(prams).then(response => {
        console.log('测试一下年级均分数据')
        console.log(response.data)
        this.termAverageData = response.data.info
      })
    },
    getSixRateData: function() {
      const prams = {
        userID: this.id
      }
      getGradeSuccessiveSixRatesData(prams).then(response => {
        console.log('测试一下历次六率数据')
        console.log(response.data)
