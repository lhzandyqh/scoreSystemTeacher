      ...
      <div class="mainContent">
        <el-tabs v-model="activeName" @tab-click="handleClick">
          <el-tab-pane label="历史科目六率对比" name="first">
            ...
            <el-row style="padding-top: 20px">
              <div class="title">
                <span style="font-size: 25px;color: #2ac06d">—历史科目六率对比表—</span>
              </div>
            </el-row>
            <el-row style="padding-top: 20px">
          ...
          <el-tab-pane label="历史单科前N名上线分布对比" name="second">
            ...
            <el-row style="padding-top: 20px">
              <div class="title">
                <span style="font-size: 25px;color: #2ac06d">—历史单科前N名上线分布图—</span>
              </div>
            </el-row>
            <el-row style="padding-top: 20px">
            ...
            <el-row style="padding-top: 20px">
              <div class="title">
                <span style="font-size: 25px;color: #2ac06d">—历史单科前N名上线分布表—</span>
              </div>
            </el-row>
            <el-row style="padding-top: 20px">
