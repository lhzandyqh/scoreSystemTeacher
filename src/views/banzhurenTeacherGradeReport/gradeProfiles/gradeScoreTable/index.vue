...
<script>
import gradeScoreTable from '@/views/banzhurenTeacherGradeReport/gradeProfiles/tableAndChart/gradeScoreTable'
import classStatisticChart from '@/views/banzhurenTeacherGradeReport/gradeProfiles/tableAndChart/classStatisticChart'
import { getGradeScoreTableData } from '@/api/banzhurenGetData'
export default {
  name: 'GradeScore',
  ...
  methods: {
    getGradeTableData: function() {
      getGradeScoreTableData().then(response => {
        console.log('班主任年级概况测试是否能够拿到年级成绩单数据')
