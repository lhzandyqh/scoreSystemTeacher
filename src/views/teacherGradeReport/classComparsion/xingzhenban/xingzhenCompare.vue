...
import { getClassCompareXingzhengSixRateaData, getClassCompareXingzhengFrontNData } from '@/api/nianjizhurenGetData'
export default {
  ...
  methods: {
    ...
    getSixRatesData: function() {
      ...
      getClassCompareXingzhengSixRateaData(prams).then(response => {
        console.log('年级主任行政班班级对比测试是否拿到六率数据')
      ...
      getClassCompareXingzhengFrontNData(prams).then(response => {
        console.log('年级主任行政班班级对比测试是否拿到前N名数据')
        console.log(response.data)
